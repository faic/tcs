...
Since in the base case $n\leq 4$, [karatsubaalg](){.ref} performs a constant number of computation, we know that $T(4) \leq c$ for some constant $c$ and for $n>4$, it satisfies the recursive equation
$$
